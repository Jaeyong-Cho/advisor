---
name: ask
description: Calibrated answer mode; clarify unclear requests, answer with progressive disclosure, and use plain language. Invoke as /ask.
...
Active for the rest of this session once invoked. Off only: "stop ask" / "normal mode".
