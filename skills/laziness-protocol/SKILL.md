...
2. **Consider deletion first.** In improvement and refactoring, find code to remove or merge before adding classes and layers. Follow [Subtract Before You Add](../subtract-before-you-add/SKILL.md) for deletion.
