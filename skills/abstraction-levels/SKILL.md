...
The flow communicates intent, domain rules remain visible, mechanisms are isolated, and dependencies respect the levels at the chosen scale. Use [Deep Module](../deep-module/SKILL.md) to judge whether the resulting interfaces reduce caller burden.
