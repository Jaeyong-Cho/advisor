---
name: principle-first-principle-redesign
...
You can explain the connection between the required purpose, behavior, responsibilities, constraints, and structural choice, and can decide how to treat the current structure. Verify implementation changes with [Closed Working Loop](../principle-closed-working-loop/SKILL.md).
