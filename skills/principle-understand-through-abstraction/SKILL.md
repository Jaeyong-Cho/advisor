---
name: principle-understand-through-abstraction
...
6. **Review and improve discovered smells.** Record every smell discovered in Chill Mode with [Record and Resolve Friction](../principle-record-and-resolve-friction/SKILL.md). Review the cause and impact after understanding the code, improve confirmed problems while preserving behavior, and verify with [Closed Working Loop](../principle-closed-working-loop/SKILL.md).
