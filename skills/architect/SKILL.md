...
3. Compare two materially different designs. Apply [Deep Module](../principle-deep-module/SKILL.md), [Model the Domain](../principle-model-the-domain/SKILL.md), and [Type System Discipline](../principle-type-system-discipline/SKILL.md). Explain the chosen tradeoff.
...
6. If repeated implementation workarounds expose a flawed assumption, apply [First Principle Redesign](../principle-first-principle-redesign/SKILL.md) and revise the contract before continuing.
