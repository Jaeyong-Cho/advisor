...
3. **Isolate boundary representations.** Do not spread HTTP requests, database records, or framework objects through domain contracts. Define internal representations with [Model the Domain](../model-the-domain/SKILL.md).
