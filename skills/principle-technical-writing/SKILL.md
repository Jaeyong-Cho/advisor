---
name: principle-technical-writing
...
6. **Review from the reader's questions.** Check whether a first reader can find the purpose, action or fact, conditions, exceptions, and evidence. Reduce unnecessary structure and reader burden with [Minimize Reader Load](../principle-minimize-reader-load/SKILL.md).
