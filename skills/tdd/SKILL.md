...
1. Understand the bug. Identify the intended behavior, current behavior, affected path, and smallest observable reproduction. When a [Bug Report](../bug-report/SKILL.md) exists, use its TDD Handoff as the starting point and recheck any remaining uncertainty before writing the test.
